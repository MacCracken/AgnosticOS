...
**M0 of the Type-3 weight-import chain.** Depends on [sigil](sigil.md) (signed header). Consumed by `anukūlana` (the Type-3 importer), attn11/tentib checkpoints, and the murti model-load seam.
