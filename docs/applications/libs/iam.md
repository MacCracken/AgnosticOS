...
`fastfetch`/`neofetch`-equivalent — system-info display for login MOTD + screenshots (Cyrius-native).

- **Repository**: [github.com/MacCracken/iam](https://github.com/MacCracken/iam)
