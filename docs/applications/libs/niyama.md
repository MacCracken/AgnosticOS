...
Regex engines — BRE / RE2 / PCRE / fuzzy / vim (Cyrius-native).

- **Repository**: [github.com/MacCracken/niyama](https://github.com/MacCracken/niyama)
- **License**: GPL-3.0-only
- **Status**: Stable — v1.0+ (folded into the Cyrius stdlib at v5.9.0)
- **Language**: Cyrius
