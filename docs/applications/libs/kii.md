...
`chafa`/`jp2a`/`viu`-equivalent — image → ANSI/ASCII-art converter for terminal display (Cyrius-native).

- **Repository**: [github.com/MacCracken/kii](https://github.com/MacCracken/kii)
