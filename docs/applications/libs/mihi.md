...
System-info probe library — CPU / RAM / GPU / kernel / uptime / distro / hostname (Cyrius-native).

- **Repository**: [github.com/MacCracken/mihi](https://github.com/MacCracken/mihi)
