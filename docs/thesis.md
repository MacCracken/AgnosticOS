...
- **AGNOS kernel** — 248 KB at v1.26.1, 33 subsystems. Not *"Linux in Cyrius."* A totally different decomposition of the kernel problem for a platform that doesn't need to support 30 years of legacy hardware.
...
**Shipped:**
- **AGNOS kernel v1.26.1** — 248 KB, 33 subsystems, 26 syscalls, TCP/IP, FAT16, VirtIO, SMP, ELF loader, kybernet as PID 1
- **Cyrius v5.9.0** — cc5 ~741 KB self-hosting from 29 KB seed; x86_64 Linux, aarch64 Linux, Apple Silicon Mach-O, Windows PE32+ — all byte-identical
