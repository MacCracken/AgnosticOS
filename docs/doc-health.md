...
> **Last refresh**: 2026-05-17 (1.30.4 xHCI Linux-diff hardening closeout + 1.30.5 Phase 4/5 USB HID-boot keyboard driver landed + Attempt 54 prep written + Phase 1-5 status block refreshed on roadmap + state.md / iron-nuc-zen-log / planning/usb-hid-keyboard-driver / planning/shared-crates rows below all touched in this sweep) | **Refresh cadence**: when docs are touched, update the affected row.
...
| `state.md` | 2026-05-17 | ✅ Fresh | **Refreshed 2026-05-17**: agnos 1.30.4 cut (xHCI H1-H4 closeout) + 1.30.5 staging (Phase 4/5 USB HID-boot keyboard driver landed, ~600 LOC, kernel 350,272 → 364,736 B, fmt-clean); slot 8 reflects Phase 4/5 dormant on archaemenid + Attempt 54 prep pending kriya 0.3.0 ship as external timing gate. Cyrius 5.11.55 active. |
...
| `iron-nuc-zen-log.md` | 2026-05-17 | 🔴 In-flight | NUC AMD (Beelink SER / archaemenid) target. ~7000 lines, Attempts 1–52 + Attempt 54 prep section. xHCI silent-absorb arc closed Attempt 52 (12 hypotheses falsified, "non-spec gate, parallel-track only"). Post-Attempt-52 handoff/AMD-quirk audit appended 2026-05-17; H1-H4 spec-discipline closeout sub-section added; Attempt 54 prep appended (externally gated on kriya 0.3.0 ship). Photo dir: `iron-nuc-zen-photos/` — attempts 33/51/52 photos organized into this dir 2026-05-17. |
