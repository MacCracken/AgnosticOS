...
| `iron-nuc-zen-log.md` | 2026-05-15 | 🔴 In-flight | **Renamed 2026-05-15** from `iron-boot-testing-log.md` (HW-prefix convention; future targets follow `iron-<arch>-<class>-log.md`). ~6500 lines, Attempts 1–29 + cleanup-pass burn. NUC AMD (Beelink SER / archaemenid) target. Cycle just closed (agnos 1.30.0 iron-validated 2026-05-15); now logs Phase 1+ of the USB-HID arc and any subsequent walls on this specific HW. Photo dir: `iron-nuc-zen-photos/`. |
...
| `planning/usb-hid-keyboard-driver.md` | 2026-05-15 | 🔴 In-flight | **NEW 2026-05-15** — 5-phase scope for closing MVP gap #3 (USB keyboard input on modern UEFI firmware; native XHCI + USB-HID-boot driver, ~1.2–2.1k Cyrius LOC, in-kernel under `agnos/kernel/arch/x86_64/usb/`). Phase 1 (PCIe discovery + capability reads) landed in agnos 1.30.1 [Unreleased] 2026-05-15. Phases 2–5 are the 1.30.1 cycle's substantive work. |
