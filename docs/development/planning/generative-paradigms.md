...
|---|----------|------------------|--------|
| 1 | **Transformer** | attention + backprop + optimizer in everything-is-i64 | **attn11** (1.13.0 — +vision lane, the sight proof; forward extracted → **rupantara**; **+hearing lane landed 2026-07-07** — STFT+mel over hisab FFT → CNN, held-out 1000/1000, suite 1066; cut pending) |
