...
> **⚠ Fossil notice (added 2026-04-11; pointer updated 2026-05-06):** This document was written before the Cyrius kernel went self-hosting on **2026-04-04 23:16 PDT** ("kernel solid" commit in the `cyrius` repo, subsequently broken out as the `agnos` repo on 2026-04-05). The v2.0 "Rust microkernel" and v3.0 "AGNOS owns the language" milestones described below were superseded inside a 44-hour window that vaporized two full release horizons. This file is preserved as a **dated snapshot** of what the roadmap looked like from the far side of that commit — not as a current plan.
>
> **Forward-looking compass**: [`docs/development/roadmap.md`](../roadmap.md) is the canonical forward-looking document going forward. The earlier 2026-04-11 fossil notice promised a separate "compass document" alongside this file; that promise is closed by declaring roadmap.md the compass. For the language pivot context, see [ADR-008](../../adr/adr-008-cyrius-as-sovereign-systems-language.md) and [docs/articles/python-in-the-bootstrap.md](../../articles/python-in-the-bootstrap.md). For live ecosystem state (Cyrius cycle, pin lag, sweeps), see [`docs/development/state.md`](../state.md).
