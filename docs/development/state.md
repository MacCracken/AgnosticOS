...
CYML — 6.0.x LEADING EDGE (the bulk of the ecosystem, ~32 repos):
  ...
  v6.0.56:  agnos (1.43.7), agnosys (1.4.0),
            ...
            klug (0.1.0)
  v6.0.61:  sigil (3.7.1)
  v6.0.87:  agnoshi (1.4.7)    ← advanced 6.0.56→6.0.87 (2026-06-08) for the
