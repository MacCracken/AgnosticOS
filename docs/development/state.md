...
CYML — 6.0.x LEADING EDGE (the bulk of the ecosystem, ~32 repos):
  ...
  v6.0.53:  libro (2.7.1)
  v6.0.56:  agnos (1.41.12), agnoshi (1.3.5), kybernet (1.3.3),
            argonaut (1.8.2)
  v6.0.61:  sigil (3.7.1)
...
| **agnos** | **1.41.12** | **6.0.56** | Kernel. The 1.41.x shell-separation arc is software-complete (full ladder in the header above); pin moved 6.0.14 → 6.0.56 at 1.41.4 (`CYRIUS_TARGET_AGNOS`). **Iron burn #1 (`14111`) found+fixed serial-only ring-3 stdout at 1.41.12** (`serial_dev_write`→`kprint`); build 1,070,704 B. A1 now FB-observable; next blocker = USB-HID input → [`#tracker-141x-cycle`](iron-nuc-zen-log.md#tracker-141x-cycle). |
