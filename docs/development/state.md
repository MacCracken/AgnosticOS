...
CYML — 6.0.x LEADING EDGE (the bulk of the ecosystem, ~32 repos):
  ...
  v6.0.53:  libro (2.7.1)
  v6.0.56:  agnos (1.41.14), agnoshi (1.4.0), kybernet (1.3.3),
            argonaut (1.8.2)
  v6.0.61:  sigil (3.7.1)
...
| **agnos** | **1.41.14** | **6.0.56** | Kernel. The 1.41.x shell-separation arc is software-complete (full ladder in the header above); pin moved 6.0.14 → 6.0.56 at 1.41.4 (`CYRIUS_TARGET_AGNOS`). Iron: `14111`→stdout fix (1.41.12); `14112`→PMM `#PF` fix (1.41.12), then typing dead, 1.41.13 i8042-poll falsified → **1.41.14 `read(0)` = `sti`+`sched_active=0`+IRQ1** (QEMU 7/7, iron-pending). build 1,070,736 B → [`#tracker-141x-cycle`](iron-nuc-zen-log.md#tracker-141x-cycle). |
