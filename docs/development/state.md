...
> **Last refresh**: 2026-05-20. Closed-beta MVP gate is green on iron (agnos 1.30.9, Attempt 68). Active scope: 1.30.x FB hardening on archaemenid Quiet Boot path.
> **Current iron state**: Attempt 76 staged (font-pixel-density fix at working-tree 1.30.11) — pending iron install. Build 422,048 B, QEMU smoke PASS at 2560×1440. gnoboot 0.4.1. See [`iron-nuc-zen-log.md`](iron-nuc-zen-log.md) for ladder.
