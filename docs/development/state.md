...
- Bare-name `cat hello.txt` falls through to initrd lookup; `cat /hello.txt` would hit the ext2 path. Documented Phase-3 behavior, not a regression — small UX papercut, address alongside `cd` / CWD scoping in a later shell cycle.
