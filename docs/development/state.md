...
CYML — 6.0.x LEADING EDGE (the bulk of the ecosystem, ~32 repos):
  ...
  v6.0.43:  mabda (3.0.1)
  v6.0.53:  libro (2.7.1)
  v6.0.56:  agnos (1.42.14), agnosys (1.4.0), agnoshi (1.4.2),
...
CYRIUS TOOLCHAIN: 6.0.61. The agnos boot-path core moved into the 6.0.5x band
  ...
  the toolchain number). hisab alone still trails at 6.0.14.
