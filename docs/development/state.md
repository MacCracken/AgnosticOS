...
> **Last refresh**: 2026-05-22 (post-1.31.7 release + **agnos 1.32.0 networking-arc cycle OPEN same-day**; lean cycle-open per "track items we still need to write work for, wait until on that particular iron").
>
