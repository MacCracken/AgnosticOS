...
- Audit receipt: [`r8169-rx-path-audit.md`](r8169-rx-path-audit.md) (still owes a closing note that AAP + bite-5 + bite-6 are all falsified and RX-drop is now wire-proven directly).
