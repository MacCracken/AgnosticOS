...
| [monolith-extraction.md](../archive/monolith-extraction.md) | Extraction from monolith to standalone repos — **archived 2026-05-12** (extraction complete; live work tracked in state.md + iron-boot-testing-log.md) |
