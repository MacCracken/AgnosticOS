...
### Tracker: 1.34.0 cycle — FAT-family filesystems (FAT write → exFAT) (OPEN 2026-05-26 — opens the additional-FS arc, roadmap row 21. FS choice decided 2026-05-26: FAT-family first; NTFS + squashfs deferred to roadmap row 23. **Lean cycle-open**: VERSION 1.33.5 → 1.34.0, CHANGELOG header, this tracker; no code bites yet.) {#tracker-1340-cycle}
