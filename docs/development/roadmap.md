...
*Last Updated: 2026-06-07 (1.41.x shell-separation iron-complete burn `14115`; 1.42.x perf+hardening + 1.43.x graphics/userland path complete — execwait #37/`run`, FB-console ANSI/SGR color, line-discipline EOF; agnos 1.43.2, agnoshi 1.4.5 + verb_abspath ls fix, anuenue 1.1.1; all QEMU-validated, ride next burn; per-cut detail in agnos CHANGELOG/state.md) | Next Review: closed-beta cut (~early June 2026)*
