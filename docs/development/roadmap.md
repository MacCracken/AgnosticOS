...
> **Status**: Pre-Beta — Closed Beta targeting **early June 2026** | **Last Updated**: 2026-05-31. This roadmap is **forward-facing** — shipped arcs live in [`state.md`](state.md) + the per-repo CHANGELOGs, not re-narrated here. Refer to state.md for current kernel / Cyrius / per-repo versions.
>
...
*Last Updated: 2026-05-31 (pruned completed 1.35.x–1.40.x arcs to CHANGELOG/state.md; active engineering arc is 1.41.x shell separation — see agnos roadmap) | Next Review: closed-beta cut (~early June 2026)*
