...
*Last Updated: 2026-06-06 (1.41.x shell-separation arc iron-complete at burn `14115`; 1.42.x landed — perf heap-zeroing + page-map/RBP/reap hardening + Track-B userland FS verbs in agnoshi 1.4.2; per-cut detail in agnos CHANGELOG/state.md) | Next Review: closed-beta cut (~early June 2026)*
