...
Which is to say: on the day this article was being drafted about how docs rot before they commit, we finally wrote a dedicated standard for where docs are supposed to live in the first place. It now lives at [`docs/development/first-party/first-party-documentation.md`](../development/first-party/first-party-documentation.md) and points at sit's ADR 0001 as the gold-standard example, at sit's architecture note 001 as the gold-standard quirk-capture, and at the code-side companion [`first-party-standards.md`](../development/first-party/first-party-standards.md) for everything that isn't docs.
