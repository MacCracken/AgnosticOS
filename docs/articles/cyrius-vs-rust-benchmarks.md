...
- **v6.2.x reserved** for bare-metal AGNOS target + RISC-V rv64 backend (was v5.10 → v5.11 → v5.12.x; v5.12.x retired 2026-05-12 at the tight-close decision; both pins moved into the v6.x platform-expansion arc).
