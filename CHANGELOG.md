...
- **`docs/development/iron-nuc-zen-log-mvp.md`** — Attempts 2 + 3 logged (each with verbatim GRUB symptom, root cause, repair-step table); Attempt 4 placeholder updated to reflect v1.29.1 as the build under test, with an outcome-interpretation table for the no-serial-cable retry. Last-updated bumped to 2026-05-13.
